...
export default function ContactFormModal({ isOpen, onClose, recipientEmail = "stefano.trapani@sales.mypos.com" }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ name: '', email: '', phone: '', company: '', monthlyVolume: '', message: '' });
      onClose();
    } catch (error) {
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Raccontaci di più sulla tua attività e le tue esigenze..."
